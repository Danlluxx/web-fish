...
CATEGORY_DESCRIPTIONS = {
    ...
    "Амфибии": "Компактный раздел с аквариумными амфибиями и отдельными карточками для просмотра и подбора.",
    "Беспозвоночные": "Крабы, креветки, раки и улитки с понятной группировкой и быстрым переходом к карточке товара.",
    "Растения": "Каталог аквариумных растений с сохранением названий из Excel-прайса для удобного сопоставления."
}
